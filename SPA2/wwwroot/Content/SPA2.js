...
{
 "use strict";
 var Global,SPA2,Client,WebSharper,Operators,Obj,UI,HtmlModule,attr,JavaScript,JSModule,Utils,EventTarget,Node,Event,UIEvent,Doc,AttrProxy,AttrModule,Pervasives,Unchecked,DomUtility,Attrs,View,Array,Elt,SC$1,Docs,DocElemNode,CharacterData,Arrays,List,T,Object,Updates,Snap,An,Client$1,Settings,Abbrev,Mailbox,Attrs$1,Dyn,Enumerator,SC$2,Fresh,SC$3,Collections,Dictionary,Docs$1,RunState,NodeSet,Anims,T$1,Seq,HashSet,SC$4,Concurrency,AppendList,SC$5,DictionaryUtil,Slice,Strings,Easing,AsyncBody,SC$6,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Queue,OperationCanceledException,HashSetUtil,SC$7,Lazy,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=window;
 SPA2=Global.SPA2=Global.SPA2||{};
 Client=SPA2.Client=SPA2.Client||{};
 ...
 {
  Doc.RunById("main",Doc.Element("button",[AttrProxy.Create("id","my-button"),AttrModule.Handler("click",function(el)
  {
   return function(ev)
   {
    return Global.alert(((((Runtime.Curried(function($1,$2,$3,$4)
    {
     return $1("You clicked "+Utils.toSafe($2)+" at x = "+Global.String($3)+", y = "+Global.String($4)+".");
    },4))(Global.id))(el.id))(ev.clientX))(ev.clientY));
   };
  })],[Doc.TextNode("Click me!")]));
 };
