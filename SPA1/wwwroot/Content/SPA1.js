...
{
 "use strict";
 var Global,Samples,HelloWorld,SC$1,WebSharper,Operators,Obj,UI,Doc,AttrModule,Elt,JavaScript,Pervasives,AttrProxy,DomUtility,Attrs,DocElemNode,Updates,View,EventTarget,Node,Unchecked,Array,Client,Attrs$1,Dyn,Snap,SC$2,JSModule,Docs,CharacterData,Arrays,List,T,Object,An,Settings,Abbrev,Mailbox,Enumerator,SC$3,Fresh,SC$4,Collections,Dictionary,Docs$1,RunState,NodeSet,Anims,T$1,Seq,HashSet,SC$5,Concurrency,AppendList,SC$6,DictionaryUtil,Slice,Strings,Easing,AsyncBody,SC$7,CT,HashSet$1,Scheduler,CancellationTokenSource,DomNodes,Queue,OperationCanceledException,HashSetUtil,SC$8,Lazy,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime,console,$,Date;
 Global=window;
 Samples=Global.Samples=Global.Samples||{};
 HelloWorld=Samples.HelloWorld=Samples.HelloWorld||{};
 SC$1=Global.StartupCode$SPA1$Client=Global.StartupCode$SPA1$Client||{};
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.Main=(welcome=Doc.Element("p",[],[Doc.TextNode("Hello!")]),Doc.RunById("main",Doc.Element("div",[],[welcome,Doc.Element("button",[AttrModule.Handler("click",function()
  {
   return function()
   {
    return welcome.SetText("Hello, world!");
   };
