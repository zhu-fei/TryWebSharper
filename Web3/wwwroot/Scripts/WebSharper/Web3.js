...
{
 "use strict";
 var Global,Web3,Client,WebSharper,UI,Var,Submitter,View,Remoting,AjaxRemotingProvider,Concurrency,Doc,AttrProxy;
 Global=window;
 Web3=Global.Web3=Global.Web3||{};
 Client=Web3.Client=Web3.Client||{};
 ...
 Client.Main=function()
 {
  ...
  {
   var b;
   return a!=null&&a.$==1?(new AjaxRemotingProvider.New()).Async("Web3:Web3.Server.DoSomething:-1840423385",[a.$0]):(b=null,Concurrency.Delay(function()
   {
